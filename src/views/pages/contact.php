<div class="relative font-sans pb-24 overflow-x-hidden">
  ...
  <!-- Hero Section -->
  <section class="relative z-10 pt-20 pb-12 max-w-7xl mx-auto px-6 text-center">
    <h1 class="text-4xl sm:text-5xl md:text-6xl lg:text-[5rem] font-semibold text-white tracking-tight leading-tight mb-6">
  ...
  <section class="relative z-10 py-12 max-w-7xl mx-auto px-6">
    <h2 class="text-3xl md:text-[48px] lg:text-[53px] text-center text-white mb-16 tracking-tight">
      Get in Touch
    </h2>
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      <div class="relative p-10 rounded-[18px] bg-[#17202c] shadow-2xl flex flex-col items-center text-center transition-all duration-300 border border-white/[0.03] hover:border-accent hover:shadow-accent hover:-translate-y-1">
        ...
        <div class="space-y-6 flex-1 flex flex-col justify-center">
          <div>
            <p class="text-white text-[18px] md:text-[23px] mb-1"><?= e($pageData['phoneSalesLabel']) ?></p>
            <p class="text-white text-[19px] md:text-[24px] tracking-wide"><?= e($pageData['phoneSalesValue']) ?></p>
          </div>
          <div>
            <p class="text-white text-[18px] md:text-[23px] mb-1"><?= e($pageData['phoneSupportLabel']) ?></p>
            <p class="text-white text-[19px] md:text-[24px] tracking-wide"><?= e($pageData['phoneSupportValue']) ?></p>
          </div>
        </div>
      </div>
      ...
      <div class="relative p-10 rounded-[18px] bg-[#17202c] shadow-2xl flex flex-col items-center text-center transition-all duration-300 border border-white/[0.03] hover:border-accent hover:shadow-accent hover:-translate-y-1">
        ...
        <div class="space-y-6 flex-1 flex flex-col justify-center w-full">
          <div>
            <p class="text-white text-[18px] md:text-[23px] mb-1"><?= e($pageData['emailSalesLabel']) ?></p>
            <p class="text-white text-[19px] md:text-[24px] tracking-wide break-all"><?= e($pageData['emailSalesValue']) ?></p>
          </div>
          <div>
            <p class="text-white text-[18px] md:text-[23px] mb-1"><?= e($pageData['emailSupportLabel']) ?></p>
            <p class="text-white text-[19px] md:text-[24px] tracking-wide break-all"><?= e($pageData['emailSupportValue']) ?></p>
          </div>
          <div>
            <p class="text-white text-[18px] md:text-[23px] mb-1"><?= e($pageData['emailGeneralLabel']) ?></p>
            <p class="text-white text-[19px] md:text-[24px] tracking-wide break-all"><?= e($pageData['emailGeneralValue']) ?></p>
          </div>
        </div>
      </div>
      ...
      <div class="relative p-10 rounded-[18px] bg-[#17202c] shadow-2xl flex flex-col items-center text-center transition-all duration-300 border border-white/[0.03] hover:border-accent hover:shadow-accent hover:-translate-y-1">
        ...
        <div class="space-y-1.5 flex-1 flex flex-col justify-center">
          <p class="text-white text-[19px] md:text-[24px] tracking-wide leading-relaxed"><?= e($pageData['addressLine1']) ?></p>
          <p class="text-white text-[19px] md:text-[24px] tracking-wide leading-relaxed"><?= e($pageData['addressLine2']) ?></p>
          <?php if ($pageData['addressLine3']): ?>
            <p class="text-white text-[19px] md:text-[24px] tracking-wide leading-relaxed"><?= e($pageData['addressLine3']) ?></p>
          <?php endif; ?>
          <p class="text-white text-[19px] md:text-[24px] tracking-wide leading-relaxed"><?= e($pageData['addressLine4']) ?></p>
          <p class="text-white text-[19px] md:text-[24px] tracking-wide leading-relaxed"><?= e($pageData['addressLine5']) ?></p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="relative z-10 py-16 max-w-6xl mx-auto px-6">
    <div class="text-center mb-10">
      <h2 class="text-3xl md:text-[48px] lg:text-[53px] text-white mb-4 tracking-tight">
        <?= e($pageData['formTitle']) ?>
      </h2>
      <p class="text-gray-300 font-light max-w-3xl mx-auto text-[20px] md:text-[25px] leading-relaxed">
    ...
    <div class="bg-[#17202c] border border-white/[0.03] rounded-[32px] p-8 md:p-14 shadow-2xl">
      ...
      <form method="POST" action="<?= e(baseUrl('/contact')) ?>" class="space-y-6">
        <div class="space-y-2">
          <label class="text-xl md:text-[30px] text-white block">Name *</label>
          <input type="text" name="name" required class="w-full bg-[#243040] text-white rounded-lg p-3.5 focus:outline-none transition-colors border border-transparent focus:border-[#4d6a8f] text-[19px]" />
        </div>

        <div class="space-y-2">
          <label class="text-xl md:text-[30px] text-white block">Email Address *</label>
          <input type="email" name="email" required class="w-full bg-[#243040] text-white rounded-lg p-3.5 focus:outline-none transition-colors border border-transparent focus:border-[#4d6a8f] text-[19px]" />
        </div>

        <div class="space-y-2">
          <label class="text-xl md:text-[30px] text-white block">Company Name <span class="text-gray-400 font-normal text-[19px] ml-1.5">(optional)</span></label>
          <input type="text" name="company" class="w-full bg-[#243040] text-white rounded-lg p-3.5 focus:outline-none transition-colors border border-transparent focus:border-[#4d6a8f] text-[19px]" />
        </div>

        <div class="space-y-3">
          <label class="text-xl md:text-[30px] text-white block">Subject</label>
          ...
          <div class="flex flex-wrap gap-3">
            ...
            ?>
              <button
                type="button"
                data-value="<?= e($sub) ?>"
                class="subject-pill px-6 py-3 rounded-md text-[19px] font-medium transition-all cursor-pointer <?= $isActive ? 'bg-white text-black font-bold shadow-md' : 'bg-[#627387] text-white hover:bg-[#6e8096]' ?>"
              >
                <?= e($sub) ?>
              </button>
            <?php endforeach; ?>
        ...
        <div class="space-y-2">
          <label class="text-xl md:text-[30px] text-white block">Message *</label>
          <textarea name="message" required rows="5" class="w-full bg-[#243040] text-white rounded-lg p-3.5 focus:outline-none transition-colors border border-transparent focus:border-[#4d6a8f] text-[19px]"></textarea>
        </div>

        <div class="space-y-4">
          <label class="text-xl md:text-[30px] text-white block">CAPTCHA</label>
          <div class="flex flex-col gap-4">
            ...
            <div class="flex items-center gap-3">
              <input type="text" name="captcha" required class="flex-1 bg-[#243040] text-white rounded-lg p-3.5 focus:outline-none text-center font-bold tracking-wider text-lg" placeholder="Enter CAPTCHA" />
            </div>
          </div>
        </div>
